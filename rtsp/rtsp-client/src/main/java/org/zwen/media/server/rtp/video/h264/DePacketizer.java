...
import org.zwen.media.core.H264Format;
...
public class DePacketizer {
	...
	public void depacket(DataPacket packet, List<MediaFrame> out) {
	...
	private void resetFrame(List<MediaFrame> out, boolean discard) {
		if (frame.readableBytes() > 0) {
			...
			MediaFrame buf = new MediaFrame();
			buf.setDiscard(discard);
			buf.setData(data);
			buf.setDuration(40);
			buf.setFormat(H264Format.H264_RTP);
