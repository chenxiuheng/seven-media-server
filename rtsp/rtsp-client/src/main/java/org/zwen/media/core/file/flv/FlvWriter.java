package org.zwen.media.core.file.flv;
...
import org.zwen.media.server.rtp.video.h264.H264AVStreamExtra;
...
public class FlvWriter implements Closeable {
	...
	public void write(MediaFrame frame) throws IOException {
		if (frame.getFormat() instanceof VideoFormat) {
			VideoFormat vf = (VideoFormat) frame.getFormat();
			if (org.zwen.media.core.H264Format.H264_RTP.equals(vf)) {
	...
	private void writeH264WithStartCode(MediaFrame frame) throws IOException {
