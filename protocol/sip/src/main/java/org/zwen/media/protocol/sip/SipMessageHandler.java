...
public class SipMessageHandler {
	 ...
	 * @throws InvalidArgumentException
	 */
	public static SipMessageHandler newInstance(LocalSipProfile localSipProfile, String localIPAddress, int localSipPort) throws PeerUnavailableException, TransportNotSupportedException,
			ObjectInUseException, InvalidArgumentException {
		return new SipMessageHandler(localSipProfile, localIPAddress, localSipPort);
	}
